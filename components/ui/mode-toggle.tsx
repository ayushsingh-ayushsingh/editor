...
export const ThemeToggleButton = ({
    ...
    return (
        <button
            onClick={toggleTheme}
            className={cn("relative w-10 h-10 rounded-full bg-secondary dark:brightness-75 brightness-90 flex items-center justify-center p-6 overflow-hidden cursor-pointer", className)}
